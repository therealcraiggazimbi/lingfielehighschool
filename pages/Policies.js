...
const Policies = () => {
  return (
    <>
      <Hero />
      <Location home="Home" page="Privacy" subpage="Policies" />
      ...
      <main className={styles.main}>
        <div>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Lingfield Advent Schools, No 22
                Lingfield Road, Gweru Zimbabwe..
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Country</strong> refers to: Zimbabwe
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Lingfield Advent Schools,
                accessible from{" "}
                <a
                  href="https://lingfieldadventschools.org/"
                  rel="noreferrer"
                  target="_blank"
                >
                  https://lingfieldadventschools.org/
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>
              <p>By email: info@lingfieldadventschools.org</p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>By phone number: 263712000894</p>
            </li>
            <li>
              <p>By mail: No 22 Lingfield Road, Gweru Zimbabwe.</p>
            </li>
          </ul>
        </div>
      </main>
